# -*- coding: utf-8 -*-
"""
HuggingFace Dataset Metadata Extractor - Mini Version (本地使用)
无 LLM 调用，配置内嵌，仅提取 HF API 可直接获取的字段。
"""
...
def fetch_readme(dataset_id):
    ...
    for attempt in range(req_config['retry_max']):
        try:
            ...
            if attempt < req_config['retry_max'] - 1:
...
if __name__ == '__main__':
    ...
    # 串行处理
    sleep_interval = CONFIG['requests']['sleep_between_items']
    ...
    output_filename = f'hf_result_{ts}.xlsx'
